...
void station_init() {
/**
 * @brief Initializes the Wi-Fi station (STA) configuration and starts the STA.
 * 
 * This function creates a new event group for managing Wi-Fi events, initializes the network interface,
 * and registers event handlers for Wi-Fi and IP events. It also initializes the Wi-Fi configuration and starts the Wi-Fi.
 * 
 * 
 */

    // Initialize the event group to manage Wi-Fi events.
